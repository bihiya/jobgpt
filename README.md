...
| [docs/AZURE.md](docs/AZURE.md) | Azure deploy (`https://jobpilot.azurewebsites.net`) |
...
**Backend:** FastAPI, Python 3.11+, Pydantic v2, Motor, Beanie, JWT + Refresh, APScheduler, Kafka, Playwright
