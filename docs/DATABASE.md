...
```json
{
  ...
  "actor_id": "string",
  "action": "job.tracked | auth.login | application.succeeded | …",
  "message": "human readable summary",
  "resource": "string",
  "resource_type": "job|user|application|approval|portal|settings|auth|…",
  "resource_id": "string",
  "job_id": "string (indexed, optional)",
  "application_id": "string",
  "source": "user|worker|system|extension",
