...
LINKEDIN_V1 = SelectorPack(
    ...
    selectors={
        ...
        # Do not use button:has-text('Apply') — that clicks company-site Apply.
        "easy_apply": [
        ...
        "easy_apply_modal": [
            ...
            "div[role='dialog']:has-text('Easy Apply')",
...
WORKDAY_V1 = SelectorPack(
    ...
    selectors={
        ...
        "use_last_application": [
            ...
            "a:has-text('Use Last Application')",
            "button:has-text('Use My Last Application')",
            "button:has-text('Use Previous Application')",
            "a:has-text('Use Previous Application')",
        ],
        "file_input": [
        ...
        "additional_file": [
            "input[data-automation-id='supportingInformation']",
            "input[data-automation-id*='additional']",
        ...
        "mfa": [
            ...
            "input[autocomplete='one-time-code']",
            "h1:has-text('Two-Step Verification')",
            "h2:has-text('Two-Step Verification')",
            "h1:has-text('Multi-factor')",
        ...
        "job_closed": [
            ...
            "text=This requisition is closed",
            "text=This position has been filled",
            "text=no longer posted",
            "h1:has-text('Job Closed')",
            "h2:has-text('Job Closed')",
            "[data-automation-id='jobClosed']",
        ],
        "wizard_title": [
            "[aria-current='step']",
            "[data-automation-id='pageHeaderTitle']",
            "[data-automation-id='applyFlowPageTitle']",
            "h2[data-automation-id='header']",
