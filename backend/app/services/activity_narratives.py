...
_NEXT_STEPS: dict[str, str] = {
    ...
    "portal.sync_requested": "Watch Job Portals or Automation — sync runs in the background.",
    "portal.synced": "New jobs are ready — run Match, or wait for automatic matching.",
    "portal.sync_failed": "Open Job Portals, expand this sync, and fix login or re-auth.",
    "portal.sync_skipped": "Re-auth or reconnect the portal, then sync again.",
    ...
    "job.pipeline_moved": "The pipeline stage changed — drag to Queued to auto-apply.",
...
_ACTION_VERBS: dict[str, str] = {
    ...
    "portal.sync_requested": "started a portal sync",
    "portal.synced": "synced a job portal",
    "portal.sync_failed": "failed a portal sync",
    "portal.sync_skipped": "skipped a portal sync",
    ...
    "job.pipeline_moved": "moved a job on the pipeline",
